...
{
    public static class DemoCodeSchema
    {
        public static int CounterDemoId => 1;

        public static string CounterDemoCode =>
                            @"<h1>Counter Demo</h1>
...
@code
    ...
    public int Counter { get; set; }
        ...
        public static int HttpDemoId => 2;

        public static string HttpDemoCode =>
...
@code {
    public IEnumerable<string> Words { get; set; } = Enumerable.Empty<string>();
        ...
        public static int EntryFormDemoId => 3;

        public static string EntryFormDemoCode =>
